...
ls -lh "$OUT_DIR/"
echo ""
echo "Upload these files to GitHub release ${VERSION} (repo: poup-s/bbDump-app):"
echo "  gh release create ${VERSION} ${OUT_DIR}/* --repo poup-s/bbDump-app --title \"${VERSION}\" --notes \"Release ${VERSION}\""
