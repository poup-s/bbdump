export const translations = {
    en: {
        ...
        proxy: {
            ...
            copyUrl: 'Copy connection string',
            urlCopied: 'Connection string copied!',
            activeTarget: 'Active target',
            setTarget: 'Set as proxy target',
            confirmTarget: 'Use "{name}" as proxy target?',
            confirmTargetMessage: 'All proxy connections will be routed to this database.',
            targetSwitched: 'Proxy target switched to {name}',
            started: 'Proxy started on port {port}',
            stopped: 'Proxy stopped',
            startError: 'Failed to start proxy: {error}',
            stopError: 'Failed to stop proxy: {error}',
            selectTargetFirst: 'Select a target database first',
            switchError: 'Failed to switch proxy target: {error}',
            portLabel: 'Port',
            portPlaceholder: 'e.g. 54320',
            portInUse: 'This port is already in use',
            portInvalid: 'Port must be between 1024 and 65535',
            configurePort: 'Configure proxy port',
            configureProxy: 'Configure',
            configurePortDesc: 'Customize the proxy connection URL. Your application will connect using the URL shown above.',
            selectTargetHint: 'Then select a target database by clicking the radio button next to it. The proxy will start automatically.',
            ...
            saveConfig: 'Apply',
            configSaved: 'Proxy configuration updated',
            statusRunning: 'Running',
            statusStopped: 'Stopped',
            activity: {
                title: 'Proxy Activity',
                empty: 'No activity yet',
                clear: 'Clear logs',
                clearConfirm: 'Clear proxy activity logs?',
                clearConfirmMessage: 'This will remove all activity logs for this project.',
                copyAll: 'Copy all',
                copied: 'Logs copied!',
                ...
                targetSwitched: 'Target switched to {name}',
            },
        },
        cardAction: {
            backup: 'Backup',
        ...
        databases: {
            ...
            noDatabases: 'No databases configured',
            noDatabasesDesc: 'Add your first PostgreSQL database to start backing up',
            configuredConnections: '{count} configured connections',
        ...
        createDatabase: {
            ...
            projectHint: 'Optionally assign this database to a project',
        ...
        viewer: {
            ...
            sqlSafetyMutationsEnabled: 'Mutations enabled (UPDATE/DELETE/INSERT) — confirmation required',
            sqlSafetyTimeout: '60-second timeout',
            sqlSafetyLimit: 'Max 5,000 rows returned',
            sqlSafetyRollback: 'Automatic rollback on error',
            sqlMutationConfirmTitle: 'Confirm mutation',
            sqlMutationConfirmMessage: 'This {operation} query will modify your database. Continue?',
            sqlMutationExecute: 'Execute',
            sqlMutationDisabled: 'SQL mutations are disabled. Enable them in Settings to run UPDATE, DELETE, INSERT queries.',
            sqlMutationsHint: 'UPDATE, DELETE, INSERT available — enable in Settings.',
            sqlMutationRowsAffected: 'row(s) affected',
            sqlMutationSuccess: 'Mutation executed successfully',
            sqlExecute: 'Execute',
            ...
            sqlAddSetItem: 'Add assignment',
            sqlAddValueRow: 'Add row',
            sqlNoWhereWarning: 'No WHERE clause — all rows will be affected!',
        ...
        settings: {
            ...
            allowSqlMutations: 'Allow SQL Mutations',
            allowSqlMutationsDesc: 'Enable UPDATE, DELETE, INSERT, DROP... in the SQL editor (with confirmation)',
            mcpSkipConfirmation: 'Skip MCP mutation confirmation',
            mcpSkipConfirmationDesc: 'AI assistants will be able to modify your databases without asking for approval',
            mcpSkipConfirmationWarning: 'Are you sure you want to disable MCP mutation confirmations? AI assistants will be able to INSERT, UPDATE and DELETE data in your databases without any approval.',
            ...
            readyToInstall: 'is ready to install.',
        ...
        about: {
            ...
            supportDesc: 'Support the development of bbdump',
            features: '...',
        ...
        onboarding: {
            ...
            recheck: 'Re-check',
            terminalOpened: 'A Terminal window has been opened',
            completeInTerminal: 'Complete the installation in Terminal, then click "Re-check" below.',
            waitingForTerminal: 'Waiting...',
            install: 'Install',
        ...
        mcp: {
            confirmTitle: 'MCP Mutation Request',
            confirmMessage: 'An AI assistant wants to modify your database:',
            approve: 'Approve',
            deny: 'Deny',
            timeoutWarning: 'Auto-denied in {seconds}s',
            database: 'Database',
            table: 'Table',
            sql: 'SQL Query',
            operation: 'Operation',
            refusedByUser: 'Mutation refused by user',
            insert: 'INSERT',
            update: 'UPDATE',
            delete: 'DELETE',
            write: 'SQL WRITE',
            alwaysAllow: 'Always allow (disable confirmations)'
        },
        tray: {
            openApp: 'Open bbdump',
            backupNow: 'Backup now',
    ...
    fr: {
        ...
        proxy: {
            ...
            copyUrl: 'Copier la chaîne de connexion',
            urlCopied: 'Chaîne de connexion copiée !',
            activeTarget: 'Cible active',
            setTarget: 'Définir comme cible du proxy',
            confirmTarget: 'Utiliser "{name}" comme cible du proxy ?',
            confirmTargetMessage: 'Toutes les connexions proxy seront redirigées vers cette base.',
            targetSwitched: 'Cible du proxy changée vers {name}',
            started: 'Proxy démarré sur le port {port}',
            stopped: 'Proxy arrêté',
            startError: 'Échec du démarrage du proxy : {error}',
            stopError: 'Échec de l\'arrêt du proxy : {error}',
            selectTargetFirst: 'Sélectionnez d\'abord une base cible',
            switchError: 'Échec du changement de cible : {error}',
            portLabel: 'Port',
            portPlaceholder: 'ex. 54320',
            portInUse: 'Ce port est déjà utilisé',
            portInvalid: 'Le port doit être entre 1024 et 65535',
            configurePort: 'Configurer le port du proxy',
            configureProxy: 'Configurer',
            configurePortDesc: 'Personnalisez l\'URL de connexion du proxy. Votre application se connectera avec l\'URL affichée ci-dessus.',
            selectTargetHint: 'Sélectionnez ensuite une base de données cible en cliquant sur le bouton radio à côté. Le proxy démarrera automatiquement.',
            connections: '{count} connexion(s)',
            noTarget: 'Pas de cible',
            userLabel: 'Utilisateur',
            passwordLabel: 'Mot de passe',
            dbNameLabel: 'Base de données',
            saveConfig: 'Appliquer',
            configSaved: 'Configuration du proxy mise à jour',
            statusRunning: 'En cours',
            statusStopped: 'Arrêté',
            activity: {
                title: 'Activité du proxy',
                empty: 'Aucune activité',
                clear: 'Effacer les logs',
                clearConfirm: 'Effacer les logs d\'activité du proxy ?',
                clearConfirmMessage: 'Cela supprimera tous les logs d\'activité de ce projet.',
                copyAll: 'Tout copier',
                copied: 'Logs copiés !',
                cleared: 'Logs effacés',
                started: 'Proxy démarré sur le port {port}',
                stopped: 'Proxy arrêté',
                connected: 'Client connecté',
                disconnected: 'Client déconnecté',
                targetSwitched: 'Cible changée vers {name}',
            },
        },
        cardAction: {
            backup: 'Backup',
        ...
        databases: {
            ...
            noDatabases: 'Aucune base configurée',
            noDatabasesDesc: 'Ajoutez votre première base PostgreSQL pour commencer les sauvegardes',
            configuredConnections: '{count} connexions configurées',
        ...
        createDatabase: {
            ...
            projectHint: 'Assigner cette base à un projet (optionnel)',
        ...
        viewer: {
            ...
            sqlSafetyMutationsEnabled: 'Mutations activées (UPDATE/DELETE/INSERT) — confirmation requise',
            ...
            sqlMutationConfirmTitle: 'Confirmer la mutation',
            sqlMutationConfirmMessage: 'Cette requête {operation} va modifier votre base. Continuer ?',
            sqlMutationExecute: 'Exécuter',
            sqlMutationDisabled: 'Les mutations SQL sont désactivées. Activez-les dans les Paramètres pour exécuter des requêtes UPDATE, DELETE, INSERT.',
            sqlMutationsHint: 'UPDATE, DELETE, INSERT disponibles — activer dans les Paramètres.',
            sqlMutationRowsAffected: 'ligne(s) affectée(s)',
            sqlMutationSuccess: 'Mutation exécutée avec succès',
            sqlExecute: 'Exécuter',
            ...
            sqlAddSetItem: 'Ajouter une assignation',
            sqlAddValueRow: 'Ajouter une ligne',
            sqlNoWhereWarning: 'Pas de clause WHERE — toutes les lignes seront affectées !',
        ...
        settings: {
            ...
            allowSqlMutations: 'Autoriser les mutations SQL',
            allowSqlMutationsDesc: 'Activer UPDATE, DELETE, INSERT, DROP... dans l\'éditeur SQL (avec confirmation)',
            mcpSkipConfirmation: 'Ignorer la confirmation des mutations MCP',
            mcpSkipConfirmationDesc: 'Les assistants IA pourront modifier vos bases de données sans demander votre approbation',
            mcpSkipConfirmationWarning: 'Êtes-vous sûr de vouloir désactiver les confirmations de mutations MCP ? Les assistants IA pourront INSERT, UPDATE et DELETE des données dans vos bases sans aucune approbation.',
            ...
            readyToInstall: 'est prête à installer.',
        ...
        about: {
            ...
            supportDesc: 'Soutenez le développement de bbdump',
            features: '...',
        ...
        onboarding: {
            ...
            recheck: 'Revérifier',
            terminalOpened: 'Une fenêtre Terminal a été ouverte',
            completeInTerminal: 'Terminez l\'installation dans le Terminal, puis cliquez sur "Revérifier" ci-dessous.',
            waitingForTerminal: 'En attente...',
            install: 'Installer',
        ...
        mcp: {
            confirmTitle: 'Demande de mutation MCP',
            confirmMessage: 'Un assistant IA souhaite modifier votre base de données :',
            approve: 'Autoriser',
            deny: 'Refuser',
            timeoutWarning: 'Refus automatique dans {seconds}s',
            database: 'Base de données',
            table: 'Table',
            sql: 'Requête SQL',
            operation: 'Opération',
            refusedByUser: 'Mutation refusée par l\'utilisateur',
            insert: 'INSERT',
            update: 'UPDATE',
            delete: 'DELETE',
            write: 'SQL WRITE',
            alwaysAllow: 'Toujours autoriser (désactiver les confirmations)'
        },
        tray: {
